local var_0_0 = class("zhenXiaHouDun", function()
...
var_0_0.layout = {
	...
	children = {
		...
		},
		{
			...
			y = visibleSize.height * 0.5 - 40,
			pic = {
				path = "res/ui/gainGeneral/xhdjj_luorigong.png"
			}
		},
		{
			name = "light",
		...
		},
		{
			...
			y = visibleSize.height * 0.5 - 40,
			pic = {
				path = "res/ui/common/halfPic/halfPic_zhenxiahoudun.png"
			}
		},
		{
			name = "namebg",
		...
		},
		{
			...
			y = visibleSize.height * 0.5 + 160,
			pic = {
				path = "res/ui/gainGeneral/xhdjj_word_xhdjjcg.png"
			}
		}
	}
}
...
function var_0_0.showEffectJinjie(arg_2_0)
	...
	var_2_2:addObject(CCCallFuncN:create(function()
		...
		var_6_0:addObject(CCCallFuncN:create(function()
			...
			roleDialogue.control.loadSpeak(1568)
		end))
