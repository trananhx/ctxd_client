local var_0_0 = class("zhenZhuRong", function()
...
var_0_0.layout = {
	...
	children = {
		...
		},
		{
			...
			y = visibleSize.height * 0.5 - 40,
			pic = {
				path = "res/ui/gainGeneral/haojiao.png"
			}
		},
		{
			name = "light",
		...
		},
		{
			...
			y = visibleSize.height * 0.5 - 40,
			pic = {
				path = "res/ui/common/halfPic/halfPic_zhenzhurong.png"
			}
		}
	}
}
...
function var_0_0.showEffectJinjie(arg_2_0)
	...
	var_2_2:addObject(CCCallFuncN:create(function()
		...
		var_6_0:addObject(CCCallFuncN:create(function()
			...
			roleDialogue.control.loadSpeak(1588)
		end))
