local var_0_0 = require("res/native/offset").get("layer.activity.HeroDrink.HeroDrinkTab")
local var_0_1 = {
	{
		"zjlyx_pb_icon_g.png",
		"zjlyx_pb_icon_h.png"
...
local var_0_9 = class("HeroDrink", function()
			...
			},
			{
				...
				children = {
					...
					},
					{
						...
						xcenter = -90 + (var_0_0.gouOffsetX or 0)
					},
					{
						fontSize = 22,
...
function var_0_9.ctor(arg_2_0, arg_2_1, arg_2_2)
	...
	arg_2_0.hejiuTime = 0
	arg_2_0.view = {}
	arg_2_0.view = autoUI.initUI(arg_2_0, var_0_10)
	...
	arg_2_0.view.yaoqinButton:registerScriptTapHandler(function()
		if arg_2_0.data.state == 3 then
			...
			cmgr.sendRequest(var_7_0, actions.getAdditionDrink, 0)
		else
			messageBox.showChargeWinWithData(language.get(10003), language.get("222118_juexingJiu", arg_2_0.data.drinkAloneGold), "heroDrinkAlone", function()
				cmgr.sendRequest(var_2_7, actions.drinkAlone)
			end)
	...
	var_0_11 = arg_2_0.data.drinkNum
	var_0_13 = arg_2_0.data.otherDrinkType or -1
	var_0_12 = arg_2_0.data.drinkType
end

function var_0_9.showEffectBaoji(arg_15_0, arg_15_1)
...
function var_0_9.allVisibleFalse(arg_17_0)
...
function var_0_9.setVisibleState(arg_18_0, arg_18_1)
...
function var_0_9.setData(arg_19_0, arg_19_1)
	if arg_19_1.zuiyi and arg_19_1.zuiyis then
		...
		for iter_19_0, iter_19_1 in ipairs(arg_19_1.zuiyis) do
			...
			if iter_19_0 == 2 or iter_19_0 == 3 then
				var_19_2 = var_19_2 and iter_19_1.received == 0
			end

			local var_19_4 = var_0_1[iter_19_0][var_19_2 and 2 or 1]
	...
	if arg_19_1.drinkType then
		local var_19_5 = var_0_8[arg_19_1.drinkType]
	...
	if arg_19_1.otherDrinkType then
		local var_19_6 = var_0_8[arg_19_1.otherDrinkType]
	...
	if arg_19_1.drinkCd and arg_19_1.drinkCd > 0 then
		...
		arg_19_0.timer:setPosition(ccp(-90 + (var_0_0.cdTiemOffsetx or 0), 0))
...
function var_0_9.onEnter(arg_21_0)
...
function var_0_9.onExit(arg_22_0)
...
function var_0_9.checkRefresh(arg_23_0)
	log.info("1111")
...
function var_0_9.refresh(arg_24_0)
	local function var_24_0(arg_25_0)
		if arg_25_0.action.data then
			...
			if arg_24_0.data.drinkNum < var_0_11 then
			...
			var_0_11 = arg_24_0.data.drinkNum
			var_0_13 = arg_24_0.data.otherDrinkType or -1
			var_0_12 = arg_24_0.data.drinkType
		end
	end

	cmgr.sendRequest(var_24_0, actions.getHeroDrinkInfo)
end

function var_0_9.onTouchBegan(arg_27_0, arg_27_1, arg_27_2)
	local function var_27_0(arg_28_0)
		...
		cmgr.sendRequest(var_28_0, actions.getAdditionDrink, arg_28_0)
	end
...
function var_0_9.onTouchMoved(arg_31_0, arg_31_1, arg_31_2)
	return
end

function var_0_9.onTouchEnded(arg_32_0, arg_32_1, arg_32_2)
	arg_32_0.isTouchOn = false
end

function var_0_9.onTouchCancelled(arg_33_0, arg_33_1, arg_33_2)
	arg_33_0.isTouchOn = false
end

function var_0_9.updateYanhuiListLayer(arg_34_0, arg_34_1)
...
function var_0_9.showDrinkWord(arg_35_0)
...
function var_0_9.showDrinkPeopleAnimation(arg_39_0)
	...
	if var_0_13 == -1 then
		if user.player.forceId == 1 then
			arg_39_0.view.peopleRight:setDisplayFrame(CCSprite:create("res/ui/common/halfPic/halfPic_caocao.png"):displayFrame())
		...
		elseif user.player.forceId == 2 then
			...
			arg_39_0.view.peopleRight:setDisplayFrame(CCSprite:create("res/ui/common/halfPic/halfPic_zhouyu.png"):displayFrame())
			arg_39_0.view.peopleRight:setScale(1.05)
			arg_39_0.view.peopleRight:setPosition(ccp(700, 159))
		end

		local var_39_0 = var_0_8[var_0_12]
...
function var_0_9.createYanhuiListTableView(arg_40_0, arg_40_1)
...
function getYanhuiListInfoCellData(arg_48_0)
	local var_48_0 = var_0_8[arg_48_0.drinkType] or var_0_8[1]
...
function var_0_9.showTips(arg_49_0)
			...
			content = {
				{
					fontSize = 22,
					type = "label",
					text = language.get("222130_juexingJiu"),
					color = var_0_2
				}
			}
		}
...
function var_0_9.showBuffTips(arg_51_0, arg_51_1)
	...
	elseif arg_51_1 == 3 then
		var_51_2 = language.get("222147_juexingJiu")
	...
	autoUI.initUI(var_51_0, var_51_7)
