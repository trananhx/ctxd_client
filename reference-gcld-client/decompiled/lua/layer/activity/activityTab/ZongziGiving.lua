...
if conf.language == "xm" then
	var_0_1.titlepic = "res/ui/activity/zongzi/dwsl_title2.png"
	var_0_1.zongzipic = "res/ui/activity/zongzi/dwsl_btn_icon_zongzi2.png"
	var_0_1.wordpic = "res/ui/activity/zongzi/dwsl_word_zzdfwl2.png"
	var_0_1.wordGreenpic = "res/ui/activity/zongzi/dwsl_word_zzyyj2.png"
	var_0_1.bgpic = "res/ui/activity/zongzi/dwsl_zongzi_bg2.png"
end
			...
			children = {
				{
					...
					x = 479.9999,
					pic = {
						path = var_0_1.titlepic or "res/ui/activity/zongzi/dwsl_title.png"
					}
				},
				{
					fontSize = 24,
				...
				},
				{
					...
					children = {
						...
						},
						{
							...
							x = 456.9758,
							pic = {
								path = var_0_1.bgpic or "res/ui/activity/zongzi/dwsl_zongzi_bg.png"
							}
						},
						{
							y = -290,
							name = "dwsl_zongzi_bg_Copy",
							type = "sprite",
							x = 641.6188,
							pic = {
								path = var_0_1.bgpic or "res/ui/activity/zongzi/dwsl_zongzi_bg.png"
							...
							children = {
								{
									...
									x = 59.5457,
									pic = {
										path = var_0_1.zongzipic or "res/ui/activity/zongzi/dwsl_btn_icon_zongzi.png"
									}
								},
								{
									y = 22.2141,
						...
						},
						{
							...
							x = 740,
							pic = {
								path = var_0_1.wordGreenpic or "res/ui/activity/zongzi/dwsl_word_zzyyj.png"
							}
						},
						{
							fontSize = 30,
					...
					children = {
						{
							...
							x = 608.9985,
							pic = {
								path = var_0_1.wordpic or "res/ui/activity/zongzi/dwsl_word_zzdfwl.png"
							}
						},
						{
							y = -270,
...
function var_0_0.giveBtnTouch(arg_9_0)
	if arg_9_0.info.giveAwayGold == 0 or arg_9_0.info.giveAwayGold == nil then
		...
		messageBox.showChargeWin("", language.get(226061, arg_9_0.info.giveAwayGold), "dwxzGiveAwayGold", function()
			cmgr.sendRequest(function(...)
				arg_9_0:refresh()
			end, actions.giveDwxz)
		end)
