...
tool.requireRes("outputMode")

outputModeUI = {}
outputModeUI.uiTable = {}

local var_0_0 = outputModeControl

function outputModeUI.show(arg_1_0)
	rmgr.loadResource("res/ui/outputMode/outputMode.plist")

	var_0_0.timeType = arg_1_0.timeType or 0
	var_0_0.resType = arg_1_0.resType or 1
	var_0_0.additionMode = arg_1_0.additionMode or 0
	var_0_0.additionCd = arg_1_0.additionCd or 0
	var_0_0.additionRate = arg_1_0.additionRate or 1

	local var_1_0 = createBaseLayer()

	smgr.registerLayer(var_1_0, "outputModeLayer")

	outputModeUI.uiTable = autoUI.initUI(var_1_0, getOutputModeData())

	outputModeUI.uiTable.closeItem:registerScriptTapHandler(function()
	...
	local var_1_3 = true
	local var_1_4 = {
		name = language.get(250016),
		callback = var_0_0.onIncomeClick,
		default = var_1_3
	}
	...
	closeItem = outputModeUI.uiTable.closeItem

	closeItem:setScale(2)

	local var_1_15 = visibleSize.width / 2 + var_1_7:getContentSize().width / 2 - outputModeUI.uiTable.closeItem:getContentSize().width
	local var_1_16 = visibleSize.height / 2 + var_1_7:getContentSize().height / 2

	outputModeUI.uiTable.closeItem:setPosition(ccp(var_1_15, var_1_16))
