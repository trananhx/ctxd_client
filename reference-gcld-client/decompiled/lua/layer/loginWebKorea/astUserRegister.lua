function showAstUserRegisterWeb(arg_1_0, arg_1_1)
	...
	local function var_1_1()
		...
		local function var_2_12()
			...
			local var_4_2 = var_2_11:getText()

			if string.len(var_4_1) >= 6 and string.len(var_4_1) <= 20 and string.len(var_4_2) >= 6 and string.len(var_4_2) <= 20 then
