...
tool.requireRes("welfareNotice")

welfareNoticeUI = {}
welfareNoticeUI.uiTable = {}

local var_0_0 = welfareNoticeControl

function welfareNoticeUI.show(arg_1_0)
	...
	welfareNoticeUI.uiTable = autoUI.initUI(var_1_0, getWelfareNoticeData())
	...
	welfareNoticeUI.click_close_item = var_1_1
	...
	welfareNoticeUI.uiTable.closeItem:registerScriptTapHandler(var_1_1)
	...
	local var_1_8 = {
		name = language.get(385001),
		callback = function()
			var_0_0.onWelfareNoticeLabelClick()
	...
	for iter_1_0, iter_1_1 in pairs(var_1_3) do
		...
		local var_1_14 = CCStrokeLabelTTF:create(iter_1_1.name, "Thonburi-Bold", 26)
	...
	closeItem = welfareNoticeUI.uiTable.closeItem
