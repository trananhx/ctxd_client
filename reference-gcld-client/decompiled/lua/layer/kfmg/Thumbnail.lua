...
local function var_0_2(arg_2_0)
	...
	local var_2_3 = arg_2_0 <= 3 and "kfyz_word_gpjw.png" or "kfyz_word_yzsl.png"
	local var_2_4 = {
		x = 20,
		type = "sprite",
		visible = false,
...
function var_0_1.handlerGetSTaskInfoAction(arg_4_0, arg_4_1)
	...
	for iter_4_0 = 1, 4 do
		arg_4_0.view.widgets["icon" .. iter_4_0]:setVisible(true)

		local var_4_1 = var_4_0["endurance" .. iter_4_0]

		if var_4_1 then
			local var_4_2 = var_4_1 == 0
			local var_4_3 = arg_4_0.view.widgets["bar" .. iter_4_0 .. 1]
			local var_4_4 = arg_4_0.view.widgets["bg_fail" .. iter_4_0]

			var_4_3:setVisible(not var_4_2)

			if not var_4_2 then
				var_4_3:setPercentage(var_4_1)
				arg_4_0.view.widgets["bar" .. iter_4_0 .. 2]:setPercentage(var_4_1)

				local var_4_5

				var_4_5 = var_4_0.attType == 1

				local var_4_6 = var_4_1 > 20 and var_4_1 <= 50
				local var_4_7 = var_4_1 > 50

				arg_4_0.view.widgets["army" .. iter_4_0 .. 1]:setVisible(var_4_6)
				arg_4_0.view.widgets["army" .. iter_4_0 .. 2]:setVisible(var_4_7)
			end
		end
	end
end
...
function var_0_1.addPoint(arg_8_0)
	...
	for iter_8_0, iter_8_1 in pairs(arg_8_0.info.city) do
		...
		local var_8_10
		local var_8_11 = worldConstant.BUILDING_INFO["world_building_" .. iter_8_1.id]
		local var_8_12 = var_8_11.x
		local var_8_13 = arg_8_0.world.mapLayer.mapInfo.mapHeight - var_8_11.y
		local var_8_14 = var_8_12 / arg_8_0.world.mapLayer.mapInfo.mapWidth * 660
		local var_8_15 = var_8_13 / arg_8_0.world.mapLayer.mapInfo.mapHeight * 396

		var_8_4:setPosition(ccp(var_8_1 + var_8_14 + var_8_9.width / 3 * 2, var_8_2 + var_8_15 - var_8_9.height / 2))
		...
		if user.kfAutoBattleCityId and user.kfAutoBattleCityId == iter_8_1.id then
			local var_8_16
			local var_8_17 = forceId == user.player.forceId and "city_js" or "city_xz"
			local var_8_18 = CCSprite:createWithSpriteFrameName(string.format("%s_a.png", var_8_17))
			local var_8_19 = CCSprite:createWithSpriteFrameName(string.format("%s_c.png", var_8_17))
			local var_8_20 = CCFadeIn:create(0.3)
			local var_8_21 = var_8_20:reverse()
			local var_8_22 = CCSequence:createWithTwoActions(var_8_20, var_8_21)

			var_8_19:runAction(CCRepeatForever:create(var_8_22))

			local var_8_23, var_8_24 = var_8_4:getPosition()

			var_8_18:setPosition(ccp(var_8_23, var_8_24))
			var_8_19:setPosition(ccp(var_8_23, var_8_24))
			arg_8_0.pointNode:addChild(var_8_19, 103)
			arg_8_0.pointNode:addChild(var_8_18, 104)
		end
	end
	...
	for iter_8_2, iter_8_3 in pairs(var_8_25) do
		local var_8_26 = arg_8_0.pointTable["thumbnail_point_" .. iter_8_2]
		local var_8_27 = true
		...
		if var_8_26 and var_8_27 then
			local var_8_28 = CCSprite:create(string.format("res/ui/kfyz/invest/kfyz_map_icon_%s.png", iter_8_3))

			var_8_28:setPosition(var_8_26:getPosition())
			var_8_28:setScale(0.4)
			arg_8_0.view.widgets.layer_map:addChild(var_8_28, 100)
		end
	end
end
...
function var_0_1.showPanel(arg_17_0, arg_17_1)
	...
	user.forceIdToName_kfmg = {}

	for iter_17_0 = 1, 3 do
		for iter_17_1, iter_17_2 in pairs(arg_17_1.nationNames) do
			user.forceIdToName_kfmg[iter_17_2.forceId] = iter_17_2.nationName

			if iter_17_2.forceId == iter_17_0 then
				arg_17_0.view.widgets["nationName" .. iter_17_0]:setString(iter_17_2.nationName)
			end
		end
	end
end
...
function var_0_1.ctor(arg_18_0, arg_18_1)
	...
	for iter_18_0 = 1, 4 do
		local var_18_0 = arg_18_0.view.widgets["btn_tip" .. iter_18_0]

		var_18_0:addHandleOfControlEvent(function()
			log.info("show tip")
			arg_18_0:showTip(true, var_18_0, iter_18_0)
