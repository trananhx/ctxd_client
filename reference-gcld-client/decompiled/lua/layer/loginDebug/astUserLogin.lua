function showAstUserLoginDebug(arg_1_0, arg_1_1)
	...
	local function var_1_1()
		...
		var_2_1:setPosition(ccp(200, 210))
		...
		var_2_4:setMaxLength(15)
		var_2_4:setReturnType(1)
		var_2_4:setText(arg_1_1.user.name)
		...
		var_2_6:setText(arg_1_1.user.pwd)
