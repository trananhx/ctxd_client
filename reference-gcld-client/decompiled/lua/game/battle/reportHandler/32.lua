function doReport32(arg_1_0, arg_1_1)
	log.info("doReport32: " .. arg_1_1)

	local var_1_0 = stringSplit(arg_1_1, "|")

	arg_1_0.reportId = tonumber(var_1_0[1])
	arg_1_0.battleTowerCD = tonumber(var_1_0[2])
	arg_1_0.battleTowerMax = tonumber(var_1_0[2])
