				...
				},
				{
					...
					children = {
						...
						},
						{
							...
							type = "sprite",
							pic = {
								path = "res/ui/activity/lantern/xbcty_icon_jty_bowl.png"
							}
						},
						{
							fontSize = 30,
				...
				},
				{
					...
					children = {
						...
						},
						{
							...
							type = "sprite",
							pic = {
								path = "res/ui/activity/lantern/yxhd_yx3.png"
							}
						},
						{
							fontSize = 30,
			...
			content = {
				{
					...
					type = "sprite",
					pic = {
						path = "res/ui/activity/lantern/xbcty_word_yxctyds.png"
					}
				}
			}
		},
...
function var_0_16.onEatLantern(arg_5_0, arg_5_1)
	local function var_5_0(arg_6_0)
		...
		var_6_3:setDisplayFrame(tool.spriteFrameByName("yxhd_yx1.png"))
...
function var_0_16.onGetLanternBigGift(arg_10_0)
	...
	cmgr.sendRequest(var_10_0, actions.getNewLanternBigGift)
end
...
function var_0_16.addLanternBowl(arg_22_0, arg_22_1)
	...
	for iter_22_0 = 1, arg_22_1 do
		local var_22_3 = CCSprite:createWithSpriteFrameName("yxhd_yx2.png")
		...
		if iter_22_0 == var_22_1 then
			...
			table.insert(arg_22_0.bowl, var_22_5)
			arg_22_0:showStreamEffect(var_22_3)

			local var_22_6 = CCArray:create()

			var_22_6:addObject(CCDelayTime:create(1))
			var_22_6:addObject(CCCallFuncN:create(function()
				var_22_5.cd = var_22_5.cd - 1

				if var_22_5.cd == 0 then
					var_22_3:stopAllActions()
					var_22_3:removeAllChildrenWithCleanup(true)
				end
			end))

			local var_22_7 = CCSequence:create(var_22_6)

			var_22_3:runAction(CCRepeatForever:create(var_22_7))
		else
		...
		if var_22_2 then
			...
			local var_22_9 = CCFadeIn:create(0.1)
			local var_22_10 = CCMoveBy:create(0.1, ccp(0, 40))

			var_22_8:addObject(CCSpawn:createWithTwoActions(var_22_9, var_22_10))

			local var_22_11 = CCSequence:create(var_22_8)

			var_22_3:runAction(var_22_11)
		end
	end

	local var_22_12 = CCLayerColor:create(ccc4(255, 255, 255, 0))

	arg_22_0.bowlNode:addChild(var_22_12)
	var_22_12:registerScriptTouchHandler(function(arg_24_0, arg_24_1, arg_24_2)
	...
	var_22_12:setTouchEnabled(true)
end
...
function var_0_16.showEatEffect(arg_25_0, arg_25_1)
	...
	if var_25_0.cd > 0 then
		...
		var_25_4:addObject(CCCallFuncN:create(function()
			...
			var_25_1:removeAllChildrenWithCleanup(true)
		end))
		...
		local var_25_6 = CCSprite:createWithSpriteFrameName("yxhd_scoop.png")
		...
		var_25_7:addObject(CCCallFuncN:create(function()
			var_25_6:setDisplayFrame(tool.spriteFrameByName("yxhd_scoop2.png"))
		end))
...
function var_0_16.addEmptyBowl(arg_31_0)
	...
	if var_31_1 > 0 then
		...
		local var_31_5 = CCSprite:createWithSpriteFrameName("yxhd_tit_w.png")
...
function var_0_16.createRankList(arg_36_0, arg_36_1)
		...
		if var_39_1 then
			...
			if var_39_1.treasureInfo then
				...
				var_39_2.widgets.btn:addHandleOfControlEvent(function()
					...
					if var_39_4 then
						arg_36_0:onGetLanternBigGift()
					else
						arg_36_0:showTip(language.get(135213, var_39_5.name, var_39_5.lea, var_39_5.str), var_39_2.widgets.btn)
					end
				end, CCControlEventTouchUpInside)
			end
		end
	...
	local function var_36_3()
		local var_41_0 = arg_36_1.rankArrs
...
function var_0_16.showTip(arg_42_0, arg_42_1, arg_42_2)
	...
	var_42_3.widgets.tipMsg:setDimensions(CCSizeMake(0, 0))

	local var_42_4, var_42_5 = tool.getPositionInScreen(arg_42_2)
	local var_42_6 = var_42_4 + 20
	local var_42_7 = var_42_5 + 20
	local var_42_8 = arg_42_1 or ""

	var_42_3.widgets.tipMsg:setString(var_42_8)

	local var_42_9 = var_42_3.widgets.tipMsg:getContentSize().width
	local var_42_10 = var_42_3.widgets.tipMsg:getContentSize().height

	var_42_3.widgets.tipFrame:setPreferredSize(CCSizeMake(var_42_9 + 30, var_42_10 + 30))
	var_42_3.widgets.tipFrame:setPosition(ccp(var_42_6, var_42_7))
	var_42_3.widgets.tipMsg:setPosition(ccp(15, 15))
	var_42_3.widgets.tipFrame:setVisible(true)
end

function var_0_16.showEffectShake(arg_44_0, arg_44_1)
	if not arg_44_1 or tolua.isnull(arg_44_1) then
		return
	end

	local var_44_0 = CCArray:create()

	var_44_0:addObject(CCMoveBy:create(0.05, ccp(-5, 0)))
	var_44_0:addObject(CCMoveBy:create(0.1, ccp(10, 0)))
	var_44_0:addObject(CCMoveBy:create(0.05, ccp(-5, 0)))
	var_44_0:addObject(CCMoveBy:create(0.05, ccp(-5, 0)))
	var_44_0:addObject(CCMoveBy:create(0.1, ccp(10, 0)))
	var_44_0:addObject(CCMoveBy:create(0.05, ccp(-5, 0)))
	...
	var_44_0:addObject(CCMoveBy:create(0.1, ccp(10, 0)))
	var_44_0:addObject(CCMoveBy:create(0.05, ccp(-5, 0)))
	var_44_0:addObject(CCDelayTime:create(0.4))

	local var_44_1 = CCSequence:create(var_44_0)

	arg_44_1:stopAllActions()
	arg_44_1:runAction(CCRepeatForever:create(var_44_1))
end

function var_0_16.showEffectBaoji(arg_45_0, arg_45_1, arg_45_2, arg_45_3)
	if arg_45_1 then
		arg_45_0:addChild(arg_45_1)
		arg_45_1:setScale(0.2)

		local function var_45_0()
			arg_45_0:removeChild(arg_45_1, true)
		...
		var_45_1:addObject(CCMoveBy:create(1, ccp(0, 60)))
		var_45_1:addObject(CCScaleTo:create(0.05, 1.1, 1.1))
		var_45_1:addObject(CCScaleTo:create(0.05, 1, 1))
		var_45_1:addObject(CCDelayTime:create(0.4))

		if type(arg_45_3) == "number" and arg_45_3 > 0 then
			var_45_1:addObject(CCDelayTime:create(arg_45_3))
		end

		var_45_1:addObject(CCCallFuncN:create(var_45_0))

		local var_45_2 = CCSequence:create(var_45_1)

		arg_45_1:runAction(var_45_2)
		arg_45_1:runAction(CCScaleTo:create(0.5, 1, 1))
	end
end

function var_0_16.showPanel(arg_47_0, arg_47_1)
	arg_47_0.info = arg_47_1

	if arg_47_0.resultNode then
		arg_47_0.resultNode:removeAllChildrenWithCleanup(true)
	end

	if arg_47_0.emptyNode then
		arg_47_0.emptyNode:removeAllChildrenWithCleanup(true)
	end

	if arg_47_0.view.widgets.timer and not tolua.isnull(arg_47_0.view.widgets.timer) then
		arg_47_0.view.widgets.timer:removeFromParentAndCleanup(true)

		arg_47_0.view.widgets.timer = nil
	end

	arg_47_0.isHot = false

	arg_47_0.view.widgets.time_pic:setVisible(arg_47_1.state == 2)
	arg_47_0.view.widgets.maskLayer1:setVisible(false)
	arg_47_0.view.widgets.maskLayer2:setVisible(false)
	arg_47_0.view.widgets.playerPic:stopAllActions()
	arg_47_0.view.widgets.playerPic:setPositionX(458)
	arg_47_0.view.widgets.node_box:setVisible(false)
	arg_47_0.view.widgets.finalEatNum:setVisible(false)
	arg_47_0.view.widgets.node_continue:setVisible(false)
	arg_47_0.view.widgets.title1:setVisible(arg_47_1.state == 1)
	arg_47_0.view.widgets.title2:setVisible(false)
	arg_47_0.view.widgets.node_main:setVisible(arg_47_1.state == 1)
	arg_47_0.view.widgets.ScrollView:setVisible(arg_47_1.state ~= 2)
	arg_47_0.view.widgets.info_end:setVisible(arg_47_1.state == 4)

	if arg_47_1.state == 1 then
		arg_47_0.view.widgets.maskLayer1:setVisible(true)
		arg_47_0.view.widgets.godTimes:setString(language.get(490026, arg_47_1.godTimes))
		arg_47_0.view.widgets.alreadyGoldBowl:setString(tostring(arg_47_1.alreadyGoldBowl))
		arg_47_0.view.widgets.richLine1:reorder()

		local var_47_0 = arg_47_1.godTimes > 0

		arg_47_0.view.widgets.icon_godGold:setVisible(not var_47_0)
		arg_47_0.view.widgets.godGold:setString(var_47_0 and language.get(85060) or arg_47_1.godGold)
		arg_47_0.view.widgets.godGold:setPosition(40, var_47_0 and 25 or 15)
		arg_47_0.view.widgets.freeRound:setString(language.get(490026, arg_47_1.freeRound))
		arg_47_0.view.widgets.alreadyRound:setString(tostring(arg_47_1.alreadyRound))
		arg_47_0.view.widgets.richLine2:reorder()

		local var_47_1 = arg_47_1.freeRound > 0

		arg_47_0.view.widgets.icon_gold:setVisible(not var_47_1)
		arg_47_0.view.widgets.gold:setString(var_47_1 and language.get(136204, arg_47_1.freeRound) or arg_47_1.gold)
		arg_47_0.view.widgets.gold:setPosition(40, var_47_1 and 25 or 15)

		local var_47_2 = 0
		local var_47_3 = #arg_47_1.progressBar

		for iter_47_0, iter_47_1 in ipairs(arg_47_1.progressBar) do
			arg_47_0.view.widgets["num" .. iter_47_0]:setString(tostring(iter_47_1.num))

			local var_47_4 = arg_47_0.view.widgets["btn_box" .. iter_47_0]
			local var_47_5 = arg_47_0.view.widgets["box" .. iter_47_0]

			var_47_4:setEnabled(false)
			var_47_5:removeAllChildrenWithCleanup(true)

			if arg_47_1.totalBowl >= iter_47_1.num then
				tool.spriteToGray(var_47_5)

				var_47_2 = var_47_2 + 100 / var_47_3
			else
				var_47_4:setEnabled(true)

				local var_47_6 = iter_47_0 == 1 and 0 or arg_47_1.progressBar[iter_47_0 - 1].num

				if var_47_6 < arg_47_1.totalBowl then
					var_47_2 = var_47_2 + 100 / var_47_3 * (arg_47_1.totalBowl - var_47_6) / (iter_47_1.num - var_47_6)
				end
			end
		end

		arg_47_0.view.widgets.bar:setPercentage(var_47_2)
		arg_47_0.view.widgets.totalBowl:setString(tostring(arg_47_1.totalBowl))
	elseif arg_47_1.state == 2 then
		arg_47_0.view.widgets.round:setString(tostring(arg_47_1.round))
		arg_47_0.view.widgets.richLine_round:reorder()
		arg_47_0.view.widgets.title2:setVisible(true)

		if arg_47_1.cd > 0 then
			local var_47_7 = CCLabelAtlas:create("", "res/ui/common/number/yxhd_time_digit2.png", 35, 39, 48)

			var_47_7:setAnchorPoint(ccp(0.5, 0.5))
			var_47_7:setString(var_0_19(arg_47_1))
			arg_47_0.view.widgets.panel:addChild(var_47_7, var_0_9)
			var_47_7:setPosition(ccp(512, 445))

			arg_47_0.view.widgets.timer = var_47_7
		end

		arg_47_0:addEmptyBowl()
	elseif arg_47_1.state == 3 then
		arg_47_0:showRoundResult()
		arg_47_0.view.widgets.maskLayer1:setVisible(true)

		local var_47_8 = arg_47_1.freeRound > 0

		arg_47_0.view.widgets.icon_gold2:setVisible(not var_47_8)
		arg_47_0.view.widgets.gold2:setString(var_47_8 and language.get(136204, arg_47_1.freeRound) or arg_47_1.gold)
		arg_47_0.view.widgets.gold2:setPosition(40, var_47_8 and 25 or 15)
	elseif arg_47_1.state == 4 then
		-- block empty
	end

	if arg_47_1.state == 2 then
		if not arg_47_0.bowl or not (#arg_47_0.bowl > 0) then
			arg_47_0:addLanternBowl()
		end
	else
		arg_47_0:addLanternBowl(0)
	end

	if arg_47_1.state == 2 then
		local var_47_9 = arg_47_0.view.widgets.timer

		if var_47_9 then
			local var_47_10 = CCArray:create()

			var_47_10:addObject(CCDelayTime:create(1))
			var_47_10:addObject(CCCallFuncN:create(function()
				arg_47_1.cd = arg_47_1.cd - 1000

				if arg_47_1.cd <= 0 or arg_47_1.state == 1 and arg_47_1.after930 == 0 and arg_47_1.cd <= 900000 then
					...
					var_47_9:setString(var_0_19(arg_47_1))
				end
			end))

			local var_47_11 = CCSequence:create(var_47_10)

			var_47_9:runAction(CCRepeatForever:create(var_47_11))
		end
	end

	arg_47_0.view.widgets.leftTime:setVisible(arg_47_1.state ~= 2)
end

function var_0_16.ctor(arg_49_0, arg_49_1, arg_49_2)
	log.info("@@ 欢庆元宵活动")
	...
	uiutil.initWidgets(arg_49_0.view, arg_49_0.layout)

	arg_49_0.leftTime = arg_49_0.view.widgets.leftTime

	if arg_49_1 then
		arg_49_0:addChild(arg_49_0.view.widgets.panel)
		arg_49_1:addChild(arg_49_0)
	end

	math.randomseed(os.time())
	arg_49_0.view.widgets.ScrollView:setTouchEnabled(false)
	swallowTouch(arg_49_0.view.widgets.bg_list)
	arg_49_0.view.widgets.btn_show:addHandleOfControlEvent(function()
		log.info("btn_show")

		local var_50_0 = arg_49_0.view.widgets.btn_show:getScale()

		log.info("scale", var_50_0)

		if var_50_0 > 0 then
			arg_49_0:onGetNewLanternRankInfo()
		end

		local var_50_1 = CCArray:create()

		var_50_1:addObject(CCMoveTo:create(0.5, ccp(var_50_0 > 0 and 613 or 1152, 256)))
		var_50_1:addObject(CCCallFuncN:create(function()
			arg_49_0.view.widgets.btn_show:setScale(-1 * var_50_0)
			arg_49_0.view.widgets.btn_show:setEnabled(true)
		end))

		local var_50_2 = CCSequence:create(var_50_1)

		arg_49_0.view.widgets.bg_list:runAction(var_50_2)
	end, CCControlEventTouchUpInside)
	arg_49_0.view.widgets.playerPic:setDisplayFrame(CCSprite:create(string.format("res/ui/common/playerPic/player%d.png", user.player.pic)):displayFrame())
	arg_49_0.view.widgets.btn_box:setOpacity(0)

	for iter_49_0 = 1, 3 do
		local var_49_0 = arg_49_0.view.widgets["btn_box" .. iter_49_0]

		var_49_0:addHandleOfControlEvent(function()
			log.info("btn_box" .. iter_49_0)

			local var_52_0 = arg_49_0.info.progressBar[iter_49_0]

			if var_52_0 then
				arg_49_0:showTip(var_52_0.tips, var_49_0)
			end
		end, CCControlEventTouchUpInside)
	end
	...
	arg_49_0.view.widgets.btn_ten:setHighlighted(var_0_0)
	arg_49_0.view.widgets.btn_ten:addHandleOfControlEvent(function()
		var_0_0 = not var_0_0

		arg_49_0.view.widgets.btn_ten:setHighlighted(var_0_0)
	end, CCControlEventTouchUpInside)
	arg_49_0.view.widgets.btn_eat1:addHandleOfControlEvent(function()
		log.info("btn_eat1")
		arg_49_0:onEatGoldSoupball()
	end, CCControlEventTouchUpInside)
	arg_49_0.view.widgets.btn_eat2:addHandleOfControlEvent(function()
		log.info("btn_eat2")
		arg_49_0:onStartEatLantern()
	end, CCControlEventTouchUpInside)
	arg_49_0.view.widgets.btn_continue:addHandleOfControlEvent(function()
		log.info("btn_continue")
		arg_49_0:onStartEatLantern()
	end, CCControlEventTouchUpInside)
	arg_49_0.view.widgets.btn_rest:addHandleOfControlEvent(function()
		log.info("btn_rest")

		if arg_49_0.info.state == 3 then
			if arg_49_0.info.title == 0 then
				arg_49_0:onGetLanternReward(true)
			else
