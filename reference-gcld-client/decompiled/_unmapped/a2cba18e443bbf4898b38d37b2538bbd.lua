	...
	children = {
		{
			...
			children = {
				...
				},
				{
					...
					type = "sprite",
					pic = {
						path = "res/ui/activity/dragonBoat/sdsxq_xuehua.png"
					}
				},
				{
					y = 490,
					...
					type = "sprite",
					pic = {
						path = "res/ui/activity/dragonBoat/sdsxq_title.png"
					}
				},
				{
					fontSize = 25,
							...
							children = {
								{
									...
									anchorPoint = ccp(0, 0),
									pic = {
										path = "res/ui/activity/dragonBoat/sdsxq_bg.jpg"
									}
								},
								{
									y = 0,
							...
							children = {
								{
									...
									x = 850,
									normal = {
										path = "res/ui/activity/dragonBoat/milub2.png"
									},
									touched = {
										path = "res/ui/activity/dragonBoat/milb.png"
									},
									children = {
										{
											type = "sprite",
...
function var_0_14.onBuySailor(arg_5_0)
	local function var_5_0(arg_6_0)
		...
		smgr.showProgramText(language.get(136284) .. "+1", colorTips.green, ccp(var_6_1, var_6_2))
		arg_5_0:refresh()
	end

	messageBox.showChargeWin("", language.get(136288, arg_5_0.info.buySailorGold), "buySailor", function()
...
function var_0_14.addAllSantas(arg_27_0)
	...
	for iter_27_0 = -2, 2 do
		...
		local var_27_2 = CCSpriteBatchNode:create("res/ui/activity/dragonBoat/santa.png")

		var_27_1:addChild(var_27_2)

		local var_27_3 = iter_27_0 == 0
		local var_27_4 = var_27_3 and 198 or 166
		local var_27_5 = var_27_3 and 76 or 50
		local var_27_6 = var_27_3 and "santa_red_walk_01.png" or "santa_green_walk_01.png"
		local var_27_7 = var_27_3 and "deer_red_walk_01.png" or "deer_green_walk_01.png"
		local var_27_8 = CCSprite:createWithSpriteFrameName(var_27_6)

		if not var_27_3 then
			local var_27_9 = CCArray:create()

			for iter_27_1 = 1, 8 do
				local var_27_10 = CCSprite:createWithSpriteFrameName(string.format("santa_green_walk_%02d.png", iter_27_1))

				var_27_9:addObject(var_27_10:displayFrame())
			end

			local var_27_11 = CCAnimation:createWithSpriteFrames(var_27_9, 0.1)
			local var_27_12 = CCAnimate:create(var_27_11)

			var_27_8:runAction(CCRepeatForever:create(var_27_12))
		end

		var_27_2:addChild(var_27_8)

		local var_27_13 = var_27_3 and 4 or 2
		local var_27_14 = {}

		for iter_27_2 = 1, var_27_13 do
			local var_27_15 = CCSprite:createWithSpriteFrameName(var_27_7)

			var_27_15:setPosition(var_27_4 + 64 * (iter_27_2 - 1), var_27_5)
			var_27_8:addChild(var_27_15)
			table.insert(var_27_14, var_27_15)

			if not var_27_3 then
				local var_27_16 = CCArray:create()

				for iter_27_3 = 1, 6 do
					local var_27_17 = CCSprite:createWithSpriteFrameName(string.format("deer_green_walk_%02d.png", iter_27_3))

					var_27_16:addObject(var_27_17:displayFrame())
				end

				local var_27_18 = CCAnimation:createWithSpriteFrames(var_27_16, 0.1)
				local var_27_19 = CCAnimate:create(var_27_18)

				var_27_15:runAction(CCRepeatForever:create(var_27_19))
			end
		end

		local var_27_20 = CCStrokeLabelTTF:create("名字", "Thonburi", 20, 1)

		var_27_20:setPosition(var_27_3 and 160 or 120, 30)
		...
		if var_27_3 then
			var_27_21 = CCStrokeLabelTTF:create("0/5", "Thonburi", 20, 1)

			var_27_21:setPosition(160, -30)
			var_27_21:setVisible(false)
			var_27_1:addChild(var_27_21)

			local var_27_23 = CCScale9Sprite:create("res/default.png")
			local var_27_24 = CCControlButton:create(var_27_23)

			var_27_24:setPreferredSize(CCSizeMake(440, 110))
			var_27_24:setPosition(134, 0)
			var_27_24:setVisible(false)
			var_27_1:addChild(var_27_24)
			var_27_24:addHandleOfControlEvent(function()
				log.info("btn_num")
				...
				if arg_27_0.num_touch >= 5 then
					...
					var_27_21:setString(string.format("%s/5", arg_27_0.num_touch))
				end
			end, CCControlEventTouchUpInside)

			arg_27_0.node_santa = var_27_1
			arg_27_0.name_santa = var_27_20
			arg_27_0.santa = var_27_8
			arg_27_0.deers = var_27_14
			arg_27_0.lbl_num = var_27_21
			arg_27_0.btn_num = var_27_24
		end
...
function var_0_14.setSantaState(arg_29_0, arg_29_1)
	...
	arg_29_0.santa:setDisplayFrame(tool.spriteFrameByName("santa_red_walk_01.png"))

	for iter_29_0, iter_29_1 in ipairs(arg_29_0.deers) do
		iter_29_1:stopAllActions()
		iter_29_1:setPosition(198 + 64 * (iter_29_0 - 1), 76)
		iter_29_1:setDisplayFrame(tool.spriteFrameByName("deer_red_walk_01.png"))
	end

	if arg_29_1 == var_0_8 or arg_29_1 == var_0_9 then
		local var_29_0 = CCArray:create()

		if arg_29_1 == var_0_8 then
			for iter_29_2 = 1, 8 do
				local var_29_1 = CCSprite:createWithSpriteFrameName(string.format("santa_red_walk_%02d.png", iter_29_2))

				var_29_0:addObject(var_29_1:displayFrame())
			end
		elseif arg_29_1 == var_0_9 then
			for iter_29_3 = 1, 28 do
				local var_29_2 = CCSprite:createWithSpriteFrameName(string.format("santa_red_attacked_%02d.png", iter_29_3))

				var_29_0:addObject(var_29_2:displayFrame())
			end
		end

		local var_29_3 = CCAnimation:createWithSpriteFrames(var_29_0, arg_29_1 == var_0_8 and 0.1 or 0.04)
		local var_29_4 = CCAnimate:create(var_29_3)

		arg_29_0.santa:runAction(CCRepeatForever:create(var_29_4))

		for iter_29_4, iter_29_5 in ipairs(arg_29_0.deers) do
			local var_29_5 = CCArray:create()

			if arg_29_1 == var_0_8 then
				for iter_29_6 = 1, 6 do
					local var_29_6 = CCSprite:createWithSpriteFrameName(string.format("deer_red_walk_%02d.png", iter_29_6))

					var_29_5:addObject(var_29_6:displayFrame())
				end
			elseif arg_29_1 == var_0_9 then
				iter_29_5:setPosition(204 + 64 * (iter_29_4 - 1), 90)

				for iter_29_7 = 1, 28 do
					local var_29_7 = CCSprite:createWithSpriteFrameName(string.format("deer_red_attacked_%02d.png", iter_29_7))

					var_29_5:addObject(var_29_7:displayFrame())
				end
			end

			local var_29_8 = CCAnimation:createWithSpriteFrames(var_29_5, arg_29_1 == var_0_8 and 0.1 or 0.04)
			local var_29_9 = CCAnimate:create(var_29_8)

			iter_29_5:runAction(CCRepeatForever:create(var_29_9))
		end
	end

	arg_29_0.node_santa:stopAllActions()

	local var_29_10 = arg_29_0.node_santa:getPositionX()
	local var_29_11
	...
	if var_29_11 then
		local var_29_12 = math.abs(var_29_11 - var_29_10) / 50
		local var_29_13 = CCArray:create()

		var_29_13:addObject(CCMoveBy:create(var_29_12, ccp(var_29_11 - var_29_10, 0)))
		var_29_13:addObject(CCCallFunc:create(function()
			return
		end))

		local var_29_14 = CCSequence:create(var_29_13)

		arg_29_0.node_santa:runAction(var_29_14)
	end
...
function var_0_14.showEffectSnowball(arg_47_0)
	...
	arg_47_0.view.widgets.btn_snowball:setPosition(860, 230)

	local var_47_0 = CCArray:create()

	var_47_0:addObject(CCMoveTo:create(6, ccp(250, 230)))
...
function var_0_14.showEffectMatchEnd(arg_49_0)
	...
	local var_49_1 = CCSprite:create("res/ui/activity/dragonBoat/sdsxq_word_xqdsjs.png")
...
function var_0_14.showPanel(arg_53_0, arg_53_1)
	...
	if var_53_0 then
		...
		arg_53_0.view.widgets.needDeer:setString(language.get(136290))
		...
		arg_53_0.view.widgets.deerInfo:setString(language.get(136283, arg_53_1.speed, arg_53_1.nowNum, arg_53_1.maxNum))
		...
		if arg_53_1.allMatchEndCd > 0 then
			...
			elseif type(arg_53_1.cityId) == "number" then
				...
				arg_53_0.view.widgets.freeTimes:setString(language.get(136282))
				arg_53_0.view.widgets.freeTimes:setVisible(true)
			end
		else
			arg_53_0.view.widgets.btn_startMatch:setVisible(false)
	...
	if var_53_0 or var_53_2 then
		...
		arg_53_0.node_santa:setPosition(80, 220)
...
function var_0_14.ctor(arg_57_0, arg_57_1, arg_57_2)
	...
	for iter_57_1 = 1, 15 do
		local var_57_7 = CCSprite:createWithSpriteFrameName(string.format("snowball_%02d.png", iter_57_1))
