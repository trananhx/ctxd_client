...
var_0_15.layout = {
	...
	children = {
		...
		},
		{
			...
			pic = {
				frame = true,
				path = "qm_meishuzi_qmcqtjjks.png"
			},
			zorder = var_0_8
		},
		{
...
local function var_0_16(arg_3_0, arg_3_1)
	...
	local var_3_3 = CCSprite:createWithSpriteFrameName("qm_meishuzi_long.png")
...
function var_0_15.onEatLantern(arg_9_0, arg_9_1)
	local function var_9_0(arg_10_0)
		...
		var_10_3:setDisplayFrame(tool.spriteFrameByName("qm_icon_qt_1.png"))
...
function var_0_15.showStreamEffect(arg_23_0, arg_23_1)
	...
	var_23_0:setPosition(ccp(75, 160))
...
function var_0_15.addLanternBowl(arg_24_0, arg_24_1)
	...
	for iter_24_0 = 1, arg_24_1 do
		local var_24_3 = CCSprite:createWithSpriteFrameName("qm_icon_qt_4.png")
...
function var_0_15.showEatEffect(arg_27_0, arg_27_1)
	...
	if var_27_0.cd > 0 then
		...
		local var_27_6 = CCSprite:createWithSpriteFrameName("qm_icon_shou_1.png")

		var_27_6:setPosition(ccp(var_27_0.pos * 300 - 30 - 40, 150))
		...
		var_27_7:addObject(CCCallFuncN:create(function()
			var_27_6:setDisplayFrame(tool.spriteFrameByName("qm_icon_shou_2.png"))
		end))
		...
		tolua.cast(var_27_0.obj, "CCSprite"):setDisplayFrame(tool.spriteFrameByName("qm_icon_qt_" .. tostring(4 - var_27_0.num) .. ".png"))
...
local function var_0_17(arg_32_0)
	...
	local var_32_0 = CCSpriteBatchNode:create("res/ui/activity/lantern/lanternPic3.png")

	for iter_32_0 = 1, arg_32_0 do
		local var_32_1 = CCSprite:createWithSpriteFrameName("qm_icon_zhenglong.png")

		if iter_32_0 == 1 then
			var_32_1:setPosition(ccp(0, 0))
		else
			var_32_1:setPosition(ccp(0, (iter_32_0 - 2) * 13 + 13))
		end
...
function var_0_15.addEmptyBowl(arg_33_0)
	...
	local var_33_2 = math.ceil(var_33_1 / 3)
	...
	if var_33_1 > 0 then
		...
		local var_33_5 = CCSprite:createWithSpriteFrameName("qm_meishuzi_long.png")
...
function var_0_15.ctor(arg_43_0, arg_43_1, arg_43_2)
	...
	rmgr.loadResource("res/ui/activity/lantern/lanternPic3.plist")
