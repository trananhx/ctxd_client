...
local function var_0_16(arg_3_0, arg_3_1)
	...
	local var_3_3 = CCSprite:createWithSpriteFrameName("dwhd_word_ge.png")
...
function var_0_15.onEatLantern(arg_9_0, arg_9_1)
	local function var_9_0(arg_10_0)
		...
		var_10_3:setDisplayFrame(tool.spriteFrameByName("dwhd_zy.png"))
...
function var_0_15.addLanternBowl(arg_24_0, arg_24_1)
	...
	for iter_24_0 = 1, arg_24_1 do
		local var_24_3 = CCSprite:createWithSpriteFrameName("dwhd_zy.png")
		...
		local var_24_5 = CCSprite:createWithSpriteFrameName("dwhd_zz.png")
		local var_24_6 = CCSprite:createWithSpriteFrameName("dwhd_zz.png")
		local var_24_7 = CCSprite:createWithSpriteFrameName("dwhd_zz.png")

		var_24_3:addChild(var_24_5, 1, 10003)
		var_24_5:setPosition(ccp(152, 71))
		var_24_3:addChild(var_24_6, 2, 10002)
		var_24_6:setPosition(ccp(110, 60))
		var_24_3:addChild(var_24_7, 3, 10001)
		var_24_7:setPosition(ccp(60, 50))
		...
		if iter_24_0 == var_24_1 then
			...
			table.insert(arg_24_0.bowl, var_24_8)
			arg_24_0:showStreamEffect(var_24_3)

			local var_24_9 = CCArray:create()

			var_24_9:addObject(CCDelayTime:create(1))
			var_24_9:addObject(CCCallFuncN:create(function()
				var_24_8.cd = var_24_8.cd - 1

				if var_24_8.cd == 0 then
					var_24_3:stopAllActions()
					var_24_3:removeChildByTag(888, true)
				end
			end))

			local var_24_10 = CCSequence:create(var_24_9)

			var_24_3:runAction(CCRepeatForever:create(var_24_10))
		else
		...
		if var_24_2 then
			...
			local var_24_11 = CCArray:create()
			local var_24_12 = CCFadeIn:create(0.1)
			local var_24_13 = CCMoveBy:create(0.1, ccp(0, 40))

			var_24_11:addObject(CCSpawn:createWithTwoActions(var_24_12, var_24_13))

			local var_24_14 = CCSequence:create(var_24_11)

			var_24_3:runAction(var_24_14)
		end
	end

	local var_24_15 = CCLayerColor:create(ccc4(255, 255, 255, 0))

	arg_24_0.bowlNode:addChild(var_24_15)
	var_24_15:registerScriptTouchHandler(function(arg_26_0, arg_26_1, arg_26_2)
	...
	var_24_15:setTouchEnabled(true)
end
...
function var_0_15.showEatEffect(arg_27_0, arg_27_1)
	...
	if var_27_0.cd > 0 then
		...
		var_27_4:addObject(CCCallFuncN:create(function()
			...
			var_27_1:removeChildByTag(888, true)
		end))
		...
		local var_27_6 = CCSprite:createWithSpriteFrameName("dwhd_hand.png")
		...
		var_27_7:addObject(CCCallFuncN:create(function()
			var_27_6:setDisplayFrame(tool.spriteFrameByName("dwhd_hand_c.png"))
		end))
		...
		for iter_27_0 = 1, var_27_0.num do
			local var_27_9 = var_27_1:getChildByTag(10000 + iter_27_0)

			if var_27_9 then
				var_27_9:setVisible(false)
			end
		end
...
local function var_0_17(arg_32_0)
	...
	local var_32_0 = CCSpriteBatchNode:create("res/ui/activity/lantern/lanternPic2.png")

	for iter_32_0 = 1, arg_32_0 do
		local var_32_1 = CCSprite:createWithSpriteFrameName("dwhd_zy.png")

		if iter_32_0 == 1 then
			var_32_1:setDisplayFrame(tool.spriteFrameByName("dwhd_zy.png"))
			var_32_1:setPosition(ccp(0, 0))
		else
			var_32_1:setPosition(ccp(0, (iter_32_0 - 2) * 20 + 13))
		end

		var_32_1:setScale(0.8)
...
function var_0_15.addEmptyBowl(arg_33_0)
	...
	if var_33_1 > 0 then
		...
		local var_33_5 = CCSprite:createWithSpriteFrameName("dwhd_word_ge.png")
